...
//       timerRef.current = setTimeout(() => setOpen(false), 5200);
//     };
...
//             className="pointer-events-auto w-[min(520px,92vw)] rounded-2xl border border-border/25 bg-background/70 backdrop-blur-xl shadow-[0_18px_55px_rgba(0,0,0,0.35)]"
//           >
...
// // ✅ Premium timings
// const FIRST_SHOW_DELAY = 3800; // 3-4 sec after load
// const AUTO_HIDE_MS = 5200;

// const MIN_GAP_AFTER_CLOSE = 9000; // close ke baad next nudge gap
// const MIN_GAP_BETWEEN_SHOWS = 7500; // safety net
// const MIN_GAP_PER_SECTION = 12000; // same section repeat avoid
...
//   const lastSectionShownAtRef = useRef({}); // { [id]: time }
...
//     // ✅ initial welcome nudge after 3-4s
