...
//     if (!el) return;
//     // mobile: keep it clean (no hover move)
...
//     // gentle premium tilt
//     mvX.set(dx * 10); // rotateY
//     mvY.set(-dy * 8); // rotateX
//   };
...
//     // tiny haptic on mobile (optional, very subtle)
...
//       <span
//         aria-hidden
//         className="pointer-events-none absolute -inset-10 opacity-0 blur-3xl transition duration-700 group-hover:opacity-70
