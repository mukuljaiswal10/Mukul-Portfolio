...
// export function filterPosts(posts, { q, cat, tag, sort } = {}) {
//     let out = [...(posts || [])];
...
//     if (sort === "oldest") out.sort((a, b) => new Date(a.date) - new Date(b.date));
//     if (sort === "read") out.sort((a, b) => (a.readMins || 0) - (b.readMins || 0));
