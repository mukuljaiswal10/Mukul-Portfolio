...
// /**
//  * ✅ UPDATED:
//  * - id prop added (default "experience")
//  * - hash "#experience" आते ही auto smooth scroll
//  */
...
// /**
//  * ✅ FINAL:
//  * - section id default "experience"
//  * - scroll-mt-24 added
//  * - local hash scroll removed (ScrollToHash already handles it)
//  */
// export default function ExperienceSection({ id = "experience" }) {
//   const isHoverable = useIsHoverable();
//   const reduceMotion = usePrefersReducedMotion();
...
//   return (
//     <section id={id} ref={sectionRef} className="scroll-mt-24 py-16">
//       <style jsx global>{`
//         @keyframes expShimmer {
//           0% {
//             background-position: 0% 50%;
...
// /* ... tumhara helper hooks + components same rahenge (useIsHoverable, etc) ... */
// /* ... tumhara ExperienceCard code SAME rakho ... */
...
//   // ✅ if list changes (home limit), reset activeId
//   useEffect(() => {
...
//         {/* ✅ VIEW ALL BUTTON (only on home when limit is set) */}
