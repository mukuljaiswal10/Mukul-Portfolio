...
//   const isHome = pathname === "/" || pathname?.includes("/(site)");
...
//       },
//       {
//         label: "Go: About section",
//         hint: "#about",
//         keywords: "about intro",
//         run: () => (isHome ? scrollToId("about") : router.push("/#about")),
//       },
//       {
//         label: "Go: Skills section",
//         hint: "#skills",
//         keywords: "skills stack tech",
//         run: () => (isHome ? scrollToId("skills") : router.push("/#skills")),
//       },
//       {
//         label: "Open: Skills page",
//         hint: "/skills",
//         keywords: "skills page all",
//         run: () => router.push("/skills"),
//       },
//       {
//         label: "Go: Projects section",
//         hint: "#projects",
//         keywords: "projects work portfolio",
//         run: () =>
//           isHome ? scrollToId("projects") : router.push("/#projects"),
//       },
//       {
...
//       },
//       {
//         label: "Go: Testimonials",
//         hint: "#testimonials",
//         keywords: "testimonial reviews",
//         run: () =>
//           isHome ? scrollToId("testimonials") : router.push("/#testimonials"),
//       },
//       {
//         label: "Go: FAQ",
//         hint: "#faq",
//         keywords: "faq questions",
//         run: () => (isHome ? scrollToId("faq") : router.push("/#faq")),
//       },
//       {
//         label: "Go: Contact",
//         hint: "#contact",
//         keywords: "contact hire message",
//         run: () => (isHome ? scrollToId("contact") : router.push("/#contact")),
//       },
//     ];
//   }, [router, isHome]);
...
//             className="mx-auto mt-[12vh] w-[min(720px,92vw)] rounded-2xl border border-border/25 bg-background/85 backdrop-blur-xl shadow-[0_22px_70px_rgba(0,0,0,0.45)]"
//             onMouseDown={(e) => e.stopPropagation()}
//           >
//             <div className="p-4 sm:p-5">
//               <div className="flex items-center justify-between gap-3">
//                 <div>
//                   <p className="text-xs text-foreground/60">Command Palette</p>
//                   <p className="text-base font-semibold">Type to search…</p>
//                 </div>
...
//                 placeholder="Search: skills, projects, contact…"
...
//                       No results. Try: <b>skills</b>, <b>projects</b>,{" "}
//                       <b>contact</b>
//                     </div>
//                   ) : null}
//                 </div>
...
//               {/* ✅ IMPORTANT: scroll only inside palette (no body scroll leak) */}
//               <div className="mt-4 max-h-[46vh] overflow-y-auto overscroll-contain pr-1">
//                 <div className="space-y-2">
//                   {filtered.map((a, idx) => (
//                     <button
//                       key={a.label + idx}
...
//     if (!item) return;
//     close();
//     setTimeout(() => runAction(item, { router, pathname }), 10);
//   };
...
//                   {POPULAR_SEARCHES.slice(0, 10).map((x) => (
//                     <button
//                       key={x}
//                       type="button"
//                       onClick={() => setQ(x)}
