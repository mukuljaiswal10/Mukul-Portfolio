...
//       <TiltCard className="group flex flex-col">
//         {/* media */}
...
//           <div className="pointer-events-none absolute -inset-24 opacity-0 blur-3xl transition duration-700 group-hover:opacity-70 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.12),transparent_60%)]" />

//           <div className="absolute bottom-3 left-3 rounded-2xl border border-white/12 bg-black/45 px-3 py-1 text-xs text-white/85 backdrop-blur">
//             {p.tags?.[0] || "Project"}
//           </div>

//           {/* shine sweep */}
//           <div className="pointer-events-none absolute inset-0 overflow-hidden">
//             <div className="absolute -left-[70%] top-0 h-full w-[60%] rotate-12 bg-gradient-to-r from-transparent via-white/12 to-transparent opacity-0 blur-sm transition duration-700 group-hover:translate-x-[230%] group-hover:opacity-100" />
//           </div>
//         </div>
...
//             onClick={onClear}
//             aria-label="Clear search"
//             className="absolute right-12 top-1/2 -translate-y-1/2 rounded-xl border border-border/12 bg-foreground/[0.03] px-2 py-1 text-xs text-foreground/70 hover:bg-foreground/[0.06] cursor-pointer"
//           >
//             ✕
//           </button>
//         ) : null}
...
//                   type="button"
//                   onClick={() => setActiveTag("All")}
//                   className="rounded-xl border border-border/15 bg-foreground/[0.03] px-4 py-2 text-sm text-foreground/80 hover:bg-foreground/[0.06] cursor-pointer"
//                 >
//                   Reset filters
//                 </button>
//               ) : null}
 ...
 *
 * ✅ NEW (ID + Scroll)
 * default sectionId="projects" so /#projects works
 */
export default function ProjectsSection({
  limit,
  showViewAll = false,
