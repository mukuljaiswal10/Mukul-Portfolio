...
//           Mukul<span className="text-white/60">.dev</span>
//         </Link>
...
//                     className="absolute left-0 right-0 -bottom-1 h-[2px] rounded-full bg-white"
...
//             className="rounded-xl border border-white/15 bg-white/[0.03] p-2 md:hidden"
...
//             {/* panel (left -> right open) */}
//             <motion.aside
//               className="fixed left-0 top-0 z-[70] h-dvh w-[82%] max-w-sm border-r border-white/10 bg-black/90 md:hidden"
//               initial={{ x: "-100%" }}
//               animate={{ x: 0 }}
//               exit={{ x: "110%" }}
...
//                   Menu <span className="text-white/60">•</span>
//                 </p>
//                 <button
//                   className="rounded-xl border border-white/15 bg-white/[0.03] px-3 py-2 text-sm text-white/80"
//                   onClick={() => setOpen(false)}
//                 >
//                   Close ✕
//                 </button>
...
//                         key={l.href}
//                         href={l.href}
//                         onClick={() => setOpen(false)} // ✅ click pe close
...
//       <motion.span
//         className="absolute left-0 top-[2px] block h-0.5 w-6 bg-white/80"
//         animate={
//           open
...
//       />
//       <motion.span
//         className="absolute left-0 top-[9px] block h-0.5 w-6 bg-white/80"
//         animate={open ? { opacity: 0, x: 8 } : { opacity: 1, x: 0 }}
//         transition={{ duration: 0.18, ease: "easeInOut" }}
//       />
//       <motion.span
//         className="absolute left-0 top-[16px] block h-0.5 w-6 bg-white/80"
//         animate={
//           open
//             ? { top: "50%", rotate: -45, opacity: 1 }
...
//         scrolled
//           ? "border-b border-white/10 bg-black/85 backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.55)]"
    ...
    >
      <Container className="flex h-16 items-center justify-between">
        <Link href="/" className="font-semibold tracking-wide text-foreground">
          Mukul<span className="text-muted/70">.dev</span>
        </Link>
