...
//         cover: "/images/blog/mern-architecture.jpg", // optional (agar nahi hai to ignore)
//         content: [
//             {
//                 type: "p",
//                 text:
//                     "When MERN projects grow, messy structure kills speed. This guide gives you a scalable folder structure and clear patterns that feel enterprise—but stay developer-friendly.",
//             },
//             { type: "h2", text: "A clean folder structure (battle-tested)" },
//             {
//                 type: "code",
//                 lang: "bash",
//                 code: `src/
...
//   features/         # feature modules (auth, blog, payments)
//   lib/              # utils, helpers, constants
//   server/           # backend logic (db, services, repos)
//     db/
//     services/
//     repositories/
//   data/             # static data (blogPosts, navLinks)
//   styles/`,
//             },
//             { type: "h2", text: "3-layer rule (Controller → Service → Repo)" },
//             {
//                 type: "p",
//                 text:
//                     "Keep your route/controller thin. Put business logic in Services, and DB operations in Repositories. It makes testing easy and avoids spaghetti.",
//             },
//             { type: "h3", text: "Example service skeleton" },
//             {
//                 type: "code",
//                 lang: "js",
//                 code: `// server/services/user.service.js
// export async function getUserProfile(userId, repo) {
//   const user = await repo.findById(userId);
//   if (!user) throw new Error("User not found");
//   return { id: user.id, name: user.name, role: user.role };
// }`,
//             },
//             { type: "callout", tone: "gold", text: "Pro tip: Feature-based modules scale better than type-based folders in real projects." },
//         ],
//     },
...
//         excerpt:
//             "A clean security checklist—updates, permissions, login protection, backups, and monitoring—without overwhelming plugins.",
//         category: "WordPress",
...
//         content: [
//             { type: "p", text: "Security is not one plugin—it's a system. Use this checklist on every client site." },
//             { type: "h2", text: "Baseline essentials" },
//             {
//                 type: "list",
//                 items: [
...
//                     "Limit login attempts (server-level if possible)",
//                 ],
//             },
//             { type: "h2", text: "File permissions (quick rules)" },
//             {
//                 type: "code", lang: "bash", code: `# Typical safe permissions
// directories: 755
// files:       644
// wp-config.php: 640 (or 600)` },
//             { type: "callout", tone: "gold", text: "Always set automated backups + offsite storage. Backups are your real insurance." },
//         ],
//     },
...
//         excerpt:
//             "A production-friendly deployment strategy for MERN apps—secure, cache-friendly, and easy to maintain.",
//         category: "MERN",
...
//         content: [
//             { type: "p", text: "If deployment feels scary, your system is unclear. Docker + Nginx gives a repeatable setup." },
//             { type: "h2", text: "Basic idea" },
//             { type: "list", items: ["Nginx as reverse proxy", "API container", "UI container", "DB managed or containerized"] },
//             { type: "h2", text: "Nginx snippet" },
//             {
//                 type: "code",
//                 lang: "nginx",
//                 code: `server {
...
//     {
//         id: "p4",
//         slug: "custom-post-type-acf-workflow",
...
//         content: [
//             { type: "p", text: "CPT + ACF is powerful, but only if your structure stays clean. Here’s a pro workflow." },
//             { type: "h2", text: "CPT naming + templates" },
//             { type: "p", text: "Use predictable slugs and dedicated template parts for long-term maintainability." },
//         ],
//     },
// ];
...
//     return blogPosts.find((p) => (p.slug || "").toLowerCase() === clean) || null;
// }
...
//     return (sameCat.length ? sameCat : all).slice(0, limit);
// }
