...
export default function BlogPage() {
  const posts = getAllPosts(); // ✅ now normalized posts (author/updated/coverImage fallback)
        ...
        <Parallax from={10} to={-10}>
          <Reveal>
            ...
            <div className="mt-[100px] max-w-4xl">
              ...
              <h2 className="mt-3 text-4xl font-semibold leading-tight text-[#E7C266] sm:text-5xl">
                Learn, build & ship premium web experiences
              </h2>
